	...
	<div style="text-align: center">
		...
		<table align="center">
			...
			<tr>
				...
				<td><input type="number" name="count" value="" min="0" max="5"></td>
			</tr>
			<tr>
		...
		<br> <br> <br> <a
			href="<%=request.getContextPath()%>/buyConfirm">
			<td width="220" align="center">購入確認</td>
		</a> <br> <a href="<%=request.getContextPath()%>/userProductList">
